      ...
      >
        <View style={styles.triggerLeading}>
          <View style={styles.triggerIcon}>
            <Ionicons color={theme.colors.primaryDark} name="walk-outline" size={16} />
          </View>
          <View style={styles.triggerCopy}>
            ...
            <Text style={styles.triggerHint}>
              {value ? "Tap to change selection" : `${options.length} activities available`}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.triggerActions}>
          {value ? (
            <Pressable hitSlop={8} onPress={() => onChange(undefined)} style={styles.clearButton}>
                ...
                <View style={styles.sheetHeader}>
                  <View>
                    ...
                    <Text style={styles.sheetSubtitle}>
                      Choose one activity and estimate calorie burn in seconds.
                    </Text>
                  </View>
                ...
                <FlatList
                    ...
                    >
                      ...
                      <View style={styles.optionCopy}>
                        ...
                        <Text style={styles.optionHint}>
                          {item === value ? "Currently selected" : "Tap to choose this activity"}
                        </Text>
                      </View>
                      {item === value ? (
                  ...
                  ListEmptyComponent={
                    <View style={styles.emptyState}>
                      ...
                      <Text style={styles.emptyBody}>Try a broader search term.</Text>
                    </View>
                  }
                />
              </View>
